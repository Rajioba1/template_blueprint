...
using AvaloniaAppKit.AppShell.Services;
using AvaloniaAppKit.Core.Contracts;
using AvaloniaAppKit.Demo.Services;
using AvaloniaAppKit.Demo.ViewModels;
using AvaloniaAppKit.Demo.Views;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Logging;

namespace AvaloniaAppKit.Demo;
