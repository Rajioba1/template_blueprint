...
using CoreChangeType = TemplateBlueprint.Core.Contracts.WorkspaceChangeType;
using CoreEventArgs = TemplateBlueprint.Core.Contracts.WorkspaceChangedEventArgs;

namespace TemplateBlueprint.AppShell.ViewModels;
