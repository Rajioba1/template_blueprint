...
using TemplateBlueprint.AppShell.Services;
using TemplateBlueprint.AppShell.ViewModels;
using TemplateBlueprint.AppShell.Windows;
using TemplateBlueprint.Core.Contracts;
using CommunityToolkit.Mvvm.ComponentModel;
using CommunityToolkit.Mvvm.Input;
using Microsoft.Extensions.Logging;

namespace TemplateBlueprint.Demo.ViewModels;
...
public partial class MainWindowViewModel : ViewModelBase
{
    ...
    /// </summary>
    [ObservableProperty]
    private string _title = "TemplateBlueprint Demo";
